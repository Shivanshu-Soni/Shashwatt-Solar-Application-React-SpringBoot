    ...
    async function fetchQueryData() {
      try {
        ...
        if (response.ok) {
          ...
          setEmail(data.email);
          setQuery(data.query);
          setQueryReply(data.queryReply);
          console.log(data.queryReply);
        } else {
              ...
              <form noValidate>
                ...
                /> */}
                 <textarea
                  ...
                  onChange={handleInputChange}
                />
                {formErrors.queryReply && (
                  <p style={{ color: "red" }}>{formErrors.queryReply}</p>
                )}
                {/* <input
                  type="submit"
                  value="Submit"
