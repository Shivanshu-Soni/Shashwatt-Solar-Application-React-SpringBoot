...
function ViewInstallationRequestsList() {
  ...
  const getAllUserAction = async () => {
    let url = `http://localhost:8181/${id}/installations/received`;
...
export default ViewInstallationRequestsList;
